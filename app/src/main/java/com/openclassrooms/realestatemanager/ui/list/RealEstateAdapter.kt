...
class RealEstateAdapter(
    var realEstateList: MutableList<RealEstate>
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.realestate_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.priceText.text = utilsKt.formatCurrency(currentItem.price.toString(), true)
        holder.locationText.text = currentItem.address

        if (currentItem.isAvailable) {
            holder.availabilityText.text = context.getString(R.string.item_on_sale)
            holder.availabilityText.backgroundTintList =
                ColorStateList.valueOf(ContextCompat.getColor(context, R.color.available_color))
        } else {
            holder.availabilityText.text = context.getString(R.string.item_sold)
            holder.availabilityText.backgroundTintList =
